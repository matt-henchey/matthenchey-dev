...
<header class="sticky top-0 left-0 right-0 w-full z-40 pd-4">
	...
	<!-- Quote Section -->
	<div
		class="max-w-8xl text-center opacity-0 transition-all duration-300 h-full relative"
		class:opacity-100={isVisible}
	>
		<p
			class="text-sm md:text-lg font-medium bg-gradient-to-r from-green-600 to-green-900 dark:from-green-600 dark:to-green-900 text-transparent bg-clip-text px-4"
		>
			{currentQuote.quote}
		</p>
		<p class="text-sm md:text-md font-light text-green-900 dark:text-green-200 italic">
			{currentQuote.author}
		</p>
	</div>
	<!-- Theme Toggle -->
