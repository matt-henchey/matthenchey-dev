...
>
	<div class="max-w-6xl mx-auto px-4 py-4">
		<div class="flex justify-between items-center">
			<!-- Contact Button -->
			<div class="fixed top-4 left-4 p-2">
				<button
					on:click={onToggleContactBox}
					class="hover:text-green-500 bg-[#1a1a1a] py-2 px-4 rounded-lg border border-green-800 transition-opacity duration-200 pulse"
				>
					Contact
				</button>
			</div>
			...
			<!-- Quote Section -->
			<div
				class="w-full text-center max-w-4xl opacity-0 transition-all duration-300"
